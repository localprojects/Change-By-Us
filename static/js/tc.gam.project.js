...
tc.gam.project = function(options){
	...
	this.components = {
		...
		related_resources:new tc.gam.project_widgets.related_resources(this,this.dom.find('.box.related_resources'),{widget:this.widget},{}),
		goals:new tc.gam.project_widgets.goals(this,this.dom.find('.box.goals'),{widget:this.widget},{}),

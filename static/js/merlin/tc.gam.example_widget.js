...
tc.gam.widgets.example_widget = function(data_object, dom, deps, options) {
    ...
    this.build_merlin = function() {
        ...
        this.components.merlin = new tc.merlin(options.app, this.merlin_options);
    }
    this.build_merlin();
 ...
 */
tc.gam.widgets.example_widget.merlin_options = {
    name: 'merlin_app_id',
    dom: this.dom.find('.merlin.example-wizard'),
    next_button: this.dom.find('a.next-button'),

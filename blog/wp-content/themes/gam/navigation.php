...
<div class="navigation-links single-page-navigation">
	<span class="nav-previous"><?php previous_post_link( '&laquo; <span class="nav-meta">%link</span>' ); ?></span>
	<span class="nav-next"><?php next_post_link('%link <span class="nav-meta">&raquo;</span>'); ?></span>
